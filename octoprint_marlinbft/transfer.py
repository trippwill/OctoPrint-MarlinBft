...
class Process:
    ...
    def start(self, handler, local_basename, remote_basename, disk_path, port, baudrate, local_path, **kwargs):
        try:
            ...
            self.bft_logger.info("Finishing up...")
    ...
    def _success(self, handler, protocol, fileInfo, start_pc):
        ...
        handler.success(fileInfo.local_basename, fileInfo.remote_basename, time.perf_counter() - start_pc)
    ...
    def _fail(self, handler, protocol, error, fileInfo, start_pc):
        ...
        handler.failure(fileInfo.local_basename, fileInfo.remote_basename, time.perf_counter() - start_pc, str(error))
